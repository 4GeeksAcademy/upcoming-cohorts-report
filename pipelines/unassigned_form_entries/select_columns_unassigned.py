...
city = ['City_1', 'City_2']
form_created_at = ['2020-09-22 05:27:37.584999', '2022-11-23 12:24:36.586999']
...
dict_inputs = {'email':email, 'course':course, 'language':language, 'country':country, 'city':city,
                'form_created_at':form_created_at, 'lead_type':lead_type, 'location':location, 'ac_deal_owner_full_name':ac_deal_owner_full_name,
...
dict_output = {'fullname':fullname, 'email_u':email_u, 'form_created_at':form_created_at, 'course':course,
...
def run(unassigned):
    ...
    unassigned = unassigned[['fullname', 'email', 'form_created_at', 'course', 'language', 'academy',  
    ...
    unassigned['datetime_creation'] = pd.to_datetime(unassigned['form_created_at'])
